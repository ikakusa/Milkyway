...
namespace ConnectionReqHook {
	...
	public:
		...
		bool Initialize() override {
			uintptr_t address = SigScan("40 55 53 56 57 41 54 41 55 41 56 41 57 48 8D AC 24 B8 FE FF FF 48 81 EC ?? ?? ?? ?? 0F 29 B4 24 ?? ?? ?? ?? 48 8B 05 ?? ?? ?? ?? 48 33 C4 48 89 85 ?? ?? ?? ?? 49 8B D9");
