...
void ConnectionReqHook::create::handle(__int64* a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6, __int64 a7, __int64 a8, __int64 a9, __int64 a10, std::string* deviceId, int a12, int a13, int a14, __int64 a15, char a16, char a17, __int64 a18, int a19, std::string* platformUserId, std::string* thirdPartyName, bool thirdPartyNameOnly, __int64 a23, __int64 a24, __int64 a25, char a26) {
	...
	auto ip = reinterpret_cast<std::string*>(a5);
	if (*ip == ":0") *ip = "world";
	Notify::addNotify(new Notification(6.f, "", StringUtils::combine("Connecting to ", *ip)));
